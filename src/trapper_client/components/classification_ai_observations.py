...
from trapper_client.schemas import Location, LocationExport, AIClassificationRecord


class LocationsComponent(TrapperComponent[Location]):
    """
    Component for the ``/media_classification/api/ai-classifications`` resource.
